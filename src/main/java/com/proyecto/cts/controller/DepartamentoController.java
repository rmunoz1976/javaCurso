...
import com.proyecto.cts.service.DepartamentoService;
...
@RestController
@RequestMapping("/cts/departamento")
public class DepartamentoController {
    ...
    //Insertar
    @PostMapping("/Save")
    public ResponseEntity<GeneralResponse> save(@Validated @RequestBody DepartamentoEntity departamentoEntity) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            DepartamentoEntity savedDepartamento = departamentoService.save(departamentoEntity);
            if (Objects.nonNull(savedDepartamento)) {
    ...
    public ResponseEntity<GeneralResponse> update(@Validated @RequestBody DepartamentoEntity departamentosEntity,
                                                  @PathVariable("id") Long id) {
        generalResponse = new GeneralResponse();
        try {
            DepartamentoEntity updatedDepartamento = departamentoService.update(departamentosEntity, id);

            if (Objects.nonNull(updatedDepartamento)) {
    ...
    public ResponseEntity<GeneralResponse> deleteById(@PathVariable("id") Long id) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            DepartamentoEntity deletedDepartamento = departamentoService.deleteById(id);
