...
import com.proyecto.cts.service.MonedaService;
...
public class MonedaController {
    ...
    //Insertar
    @PostMapping("/Save")
    public ResponseEntity<GeneralResponse> save(@Validated @RequestBody MonedaEntity monedaEntity) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            MonedaEntity savedMoneda = monedaService.save(monedaEntity);
            if (Objects.nonNull(savedMoneda)) {
    ...
    public ResponseEntity<GeneralResponse> update(@Validated @RequestBody MonedaEntity monedaEntity,
                                                  @PathVariable("id") Long id) {
        generalResponse = new GeneralResponse();
        try {
            MonedaEntity updatedMoneda = monedaService.update(monedaEntity, id);

            if (Objects.nonNull(updatedMoneda)) {
    ...
    public ResponseEntity<GeneralResponse> deleteById(@PathVariable("id") Long id) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            MonedaEntity deletedMoneda = monedaService.deleteById(id);
