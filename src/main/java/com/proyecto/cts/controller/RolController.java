...
package com.proyecto.cts.controller;
        ...
        import com.proyecto.cts.service.RolService;
...
public class RolController {
    ...
    //Insertar
    @PostMapping("/Save")
    public ResponseEntity<GeneralResponse> save(@Validated @RequestBody RolEntity rolEntity) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            RolEntity savedRol = rolService.save(rolEntity);
            if (Objects.nonNull(savedRol)) {
    ...
    public ResponseEntity<GeneralResponse> update(@Validated @RequestBody RolEntity rolEntity,
                                                  @PathVariable("id") Long id) {
        generalResponse = new GeneralResponse();
        try {
            RolEntity updatedRol = rolService.update(rolEntity, id);

            if (Objects.nonNull(updatedRol)) {
    ...
    public ResponseEntity<GeneralResponse> deleteById(@PathVariable("id") Long id) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            RolEntity deletedRol = rolService.deleteById(id);
