...
import com.proyecto.cts.service.UnidadMedidaService;
...
@RestController
@RequestMapping("/cts/unidadmedida")
public class UnidadMedidaController {
    ...
    public List<UnidadMedidaEntity> list() {
        return unidadmedidaService.list();
    }

    //Insertar
    @PostMapping("/Save")
    public ResponseEntity<GeneralResponse> save(@Validated @RequestBody UnidadMedidaEntity unidadmedidaEntity) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            UnidadMedidaEntity savedUnidadMedida = unidadmedidaService.save(unidadmedidaEntity);
            if (Objects.nonNull(savedUnidadMedida)) {
    ...
    public ResponseEntity<GeneralResponse> update(@Validated @RequestBody UnidadMedidaEntity unidadmedidasEntity,
                                                  @PathVariable("id") Long id) {
        generalResponse = new GeneralResponse();
        try {
            UnidadMedidaEntity updatedUnidadMedida = unidadmedidaService.update(unidadmedidasEntity, id);

            if (Objects.nonNull(updatedUnidadMedida)) {
    ...
    public ResponseEntity<GeneralResponse> deleteById(@PathVariable("id") Long id) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            UnidadMedidaEntity deletedUnidadMedida = unidadmedidaService.deleteById(id);
