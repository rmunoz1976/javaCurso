...
import com.proyecto.cts.service.TipoDocumentoService;
...
@RestController
@RequestMapping("/cts/tipodocumento")
public class TipoDocumentoController {
    ...
    //Insertar
    @PostMapping("/Save")
    public ResponseEntity<GeneralResponse> save(@Validated @RequestBody TipoDocumentoEntity tipodocumentoEntity) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            TipoDocumentoEntity savedTipoDocumento = tipodocumentoService.save(tipodocumentoEntity);
            if (Objects.nonNull(savedTipoDocumento)) {
    ...
    public ResponseEntity<GeneralResponse> update(@Validated @RequestBody TipoDocumentoEntity tipodocumentoEntity,
                                                  @PathVariable("id") Long id) {
        generalResponse = new GeneralResponse();
        try {
            TipoDocumentoEntity updatedTipoDocumento = tipodocumentoService.update(tipodocumentoEntity, id);

            if (Objects.nonNull(updatedTipoDocumento)) {
    ...
    public ResponseEntity<GeneralResponse> deleteById(@PathVariable("id") Long id) throws Exception {
        generalResponse = new GeneralResponse();
        try {
            TipoDocumentoEntity deletedTipoDocumento = tipodocumentoService.deleteById(id);
